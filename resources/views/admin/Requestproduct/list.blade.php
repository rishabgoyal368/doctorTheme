                            ...
                            <table id="example3" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{url('/admin/edit-patient')}}/{{@$value->uploadBy()['id']}}" target="_blank">{{@$value->uploadBy()['name']}}</a></td>
                                        <td>{{@$value->getStatus()}}</td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{url('admin/change-status')}}/{{$value['id']}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    @empty
